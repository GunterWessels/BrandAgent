...
import { DetailedReportSection } from "./detailed-report-section"
    ...
    return (
      <div className="space-y-6">
        ...
        <DetailedReportSection
          ...
          data={data}
          score={scoreCategories.find((cat) => cat.id === selectedSection)?.score || 0}
        />
      </div>
    )
  }
      ...
      <Tabs defaultValue="overview" className="w-full">
        ...
        <TabsContent value="templates" className="space-y-6">
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Content Post Template</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="font-medium mb-2">Weekly Insight Post Template:</p>
                  <div className="text-sm space-y-2">
                    <p>🔍 [Industry] Insight of the Week:</p>
                    <p>[Share a specific trend, statistic, or observation]</p>
                    <p>💡 What this means for [target audience]:</p>
                    <p>[Explain the implications and actionable insights]</p>
                    <p>What's your take on this trend? Share your thoughts below! 👇</p>
                    <p>#[Industry] #[Relevant hashtags]</p>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    ...
                    onClick={() =>
                      copyToClipboard(
                        "🔍 [Industry] Insight of the Week:\n[Share a specific trend, statistic, or observation]\n\n💡 What this means for [target audience]:\n[Explain the implications and actionable insights]\n\nWhat's your take on this trend? Share your thoughts below! 👇\n\n#[Industry] #[Relevant hashtags]",
                      )
                    }
                  >
                    <Copy className="h-4 w-4 mr-1" />
